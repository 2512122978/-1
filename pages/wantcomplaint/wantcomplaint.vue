			...
			<view class="img">
				...
				<block v-else>
					<view class="image1" @click="chooseImage1()">
						<image class="image1" src="../../static/images/upload_img.png" mode=""></image>
					</view>
				</block>
				...
				<block v-else>
					<view class="image2" @click="chooseImage2()">
						<image class="image2" src="../../static/images/upload_img.png" mode=""></image>
					</view>
				</block>
				...
				<block v-else>
					<view class="image3" @click="chooseImage3()">
						<image class="image3" src="../../static/images/upload_img.png" mode=""></image>
					</view>
				</block>
			</view>
		</view>
