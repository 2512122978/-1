	...
	<view class="content">
		...
		<view class="modal" v-show="modal">
			...
			<view class="box">
				...
				<view class="title1">
					<view class="first">
					<image class="image" src="../../../static/images/pj_1.png" mode=""></image>
					<view class="text" id="text">好评</view>
					</view>
					<view class="seetingchose">
						<image class="seeting" src="../../../static/images/setting_choose.png" mode="" @click="choose()"></image>
					</view>
				</view>
				<view class="title1">
					<view class="first">
					<image class="image" src="../../../static/images/pj_2.png" mode=""></image>
					<view class="text" id="text">好评</view>
					</view>
					<view class="seetingchose">
						<image class="seeting" src="../../../static/images/setting_choose.png" mode=""></image>
					</view>
				</view>
				<view class="title1">
					<view class="first">
					<image class="image" src="../../../static/images/pj_3.png" mode=""></image>
					<view class="text" id="text">好评</view>
					</view>
					<view class="seetingchose">
						<image class="seeting" src="../../../static/images/setting_choose.png" mode=""></image>
